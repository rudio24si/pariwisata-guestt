    ...
    <div class="login-page mt-100">
      <div class="container">
        <div class="booking-login custom-shadow radius12" data-aos="fade-up">
          <div class="heading text-36">Create a new account</div>
          <div class="text text-16">
            Already have an account? <a href="{{route('login')}}" class="text text-16 no-underline text-sky">Login</a>
          </div>
          <form method="POST" action="{{route('register.post')}}" class="login-form">
            ...
            <div class="field">
              ...
              <input type="text" id="name" name="name" placeholder="User Name" value="{{ old('name') }}">
              @if($errors->has('name'))
                <div class="text text-14" style="color:#b00020">{{ $errors->first('name') }}</div>
              @endif
            </div>

            <div class="field">
              <label for="email" class="visually-hidden">Email Id</label>
              <input type="email" id="email" name="email" placeholder="Email Id" value="{{ old('email') }}">
              @if($errors->has('email'))
                <div class="text text-14" style="color:#b00020">{{ $errors->first('email') }}</div>
              @endif
            </div>
            ...
            <div class="field">
              ...
              @if($errors->has('password'))
                <div class="text text-14" style="color:#b00020">{{ $errors->first('password') }}</div>
              @endif
            </div>
            ...
            <div class="forget-password-wrap">
              <label for="keep_signed" class="checkbox-label">
                ...
                <span class="text text-16">Keep me signed in?</span>
              </label>
            </div>
