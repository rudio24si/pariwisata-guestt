                        ...
                        <form action="{{ route('homestay.update', $homestay->homestay_id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('harga_per_malam', $homestay->harga_per_malam) }}" min="0"
                                        step="1000" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" id="status"
                                        name="status">
                                        <option value="aktif"
                                            {{ old('status', $homestay->status) == 'aktif' ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="nonaktif"
                                            {{ old('status', $homestay->status) == 'nonaktif' ? 'selected' : '' }}>Nonaktif
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('fasilitas_json') is-invalid @enderror" id="fasilitas_json" name="fasilitas_json"
                                    rows="4" placeholder='["WiFi", "AC", "Parkir"]'>{{ old('fasilitas_json', json_encode($homestay->fasilitas_json)) }}</textarea>
                                <div class="form-text">
